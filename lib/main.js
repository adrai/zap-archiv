(function() {
  ...
  const NOTE_MAPPING = {
    mathematik: [
      ...
      { min: 4, max: 4, note: 1.5 },
      { min: 5, max: 5, note: 1.75 },
      { min: 6, max: 7, note: 2 },
      { min: 8, max: 8, note: 2.25 },
      { min: 9, max: 9, note: 2.5 },
      { min: 10, max: 11, note: 2.75 },
      { min: 12, max: 12, note: 3 },
      { min: 13, max: 13, note: 3.25 },
      { min: 14, max: 15, note: 3.5 },
      { min: 16, max: 16, note: 3.75 },
      { min: 17, max: 17, note: 4 },
      { min: 18, max: 19, note: 4.25 },
      { min: 20, max: 20, note: 4.5 },
      { min: 21, max: 21, note: 4.75 },
      { min: 22, max: 23, note: 5 },
      { min: 24, max: 24, note: 5.25 },
      { min: 25, max: 25, note: 5.5 },
      { min: 26, max: 27, note: 5.75 },
      { min: 28, max: 36, note: 6 }
    ],
    deutsch: [
      { min: 0, max: 8, note: 1 },
      { min: 9, max: 10, note: 1.25 },
      { min: 11, max: 12, note: 1.5 },
      { min: 13, max: 14, note: 1.75 },
      { min: 15, max: 16, note: 2 },
      { min: 17, max: 18, note: 2.25 },
      { min: 19, max: 20, note: 2.5 },
      { min: 21, max: 22, note: 2.75 },
      { min: 23, max: 24, note: 3 },
      { min: 25, max: 26, note: 3.25 },
      { min: 27, max: 28, note: 3.5 },
      { min: 29, max: 30, note: 3.75 },
      { min: 31, max: 32, note: 4 },
      { min: 33, max: 34, note: 4.25 },
      { min: 35, max: 36, note: 4.5 },
      { min: 37, max: 38, note: 4.75 },
      { min: 39, max: 40, note: 5 },
      { min: 41, max: 42, note: 5.25 },
      { min: 43, max: 44, note: 5.5 },
      { min: 45, max: 46, note: 5.75 },
      { min: 47, max: 51, note: 6 }
    ]
  };
  ...
  function createYearCard(year) {
    ...
    if (year === YEAR_START) {
      ...
      badge.textContent = translate('Neu');
  ...
  function renderYearCards() {
    ...
    getYears().forEach(function(year, index) {
      const card = createYearCard(year);
  ...
  function buildChart() {
    ...
    const gridColor = getCssVariable('--chart-grid', 'rgba(29, 53, 87, 0.1)');
    const textColor = getCssVariable('--chart-text', '#666666');
  ...
  function updateThemeToggleLabel() {
    ...
    if (!button) return;
    button.setAttribute('aria-label', translate('Farbschema wechseln'));
  }
